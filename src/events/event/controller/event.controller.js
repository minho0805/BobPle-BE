...
export const edit   = async (req,res,next)=>{ try{ return ok(res, await svc.edit(req.params.eventId, req.body, req.user)); }catch(e){ next(e);} };
export const cancel = async (req,res,next)=>{ try{ return ok(res, await svc.cancel(req.params.eventId)); }catch(e){ next(e);} };